# QA Record: edge-perception-control-module

## Project
- Source language: zh-CN
- Target language: en-US
- Audience: student-facing lab manual
- Source DOCX: `source/edge-perception-control-module/《端感知控制模组V3.1》实验手册.docx`
